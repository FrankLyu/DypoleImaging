...
class ImageUI(wx.Frame):
    ...
    from _InitUIstuff import InitUI, startCamera_trigger, endCamera_trigger, onAtomRadioClicked, updateFittingResult, TOFcalc, Fit2Dshow
...
#            print "----------Let's kill the old observer---------------------"
    ...
    def dictionnaryAnalysisResults(self):
        ...
        if self.fitMethodFermion.GetValue():
            analysisResults["PSD"]=self.primaryAOI.fermionzeta
