...
def setZoomImage(self, data):
    ...
    self.axesZoom.cla()
    self.currentZoomImage = self.axesZoom.imshow(dataZoom, cmap=self.cmap, aspect='equal', vmin=-0.1, vmax=self.vmax, extent=[self.xMinZoom, self.xMaxZoom, self.yMaxZoom, self.yMinZoom])
