...
def acquire_and_display_images(cam, nodemap, nodemap_tldevice, axes, canvas):
    """
...
def run_single_camera(cam, axes, canvas):
    """
    ...
    try:
        ...
        # Acquire images
        result &= acquire_and_display_images(cam, nodemap, nodemap_tldevice, axes, canvas)
...
def main(axes, canvas):
    ...
    for i, cam in enumerate(cam_list):
        ...
        result &= run_single_camera(cam, axes, canvas)
    ...
    input('Main Done! Press Enter to exit...')
    return result
