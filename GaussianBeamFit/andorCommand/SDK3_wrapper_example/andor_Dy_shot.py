...
def main() :
    ...
    if deviceCount > 0 :
        try:
            ...
            #sdk3.set_bool(hndl, "Overlap", True)
            #sdk3.set_enum_string(hndl, "TriggerMode", "")
            sdk3.set_enum_string(hndl, "TriggerMode", "External")
            TriggerMode = sdk3.get_enum_string(hndl, "TriggerMode")
            print("TriggerMode is : ",TriggerMode);
