...
def on_release(self, event):
    ...
    if activeAOI.position[2] + 1 >= self.imageData.shape[1]: activeAOI.position[2] = self.imageData.shape[1] - 2
    if activeAOI.position[3] + 1 >= self.imageData.shape[0]: activeAOI.position[3] = self.imageData.shape[0] - 2
